...
class calibration : public TSelector {
 public :
  ...
  TH1F            *fTim3_full;  
  TH1F            *fTim4_full;
  TH2F            *yx_position_mkj; 
  TH2F            *yx_position_cal; 
 ...
 calibration(TTree * /*tree*/ =0) : fChain(0) {fPulseInt = 0, fPulseInt_poiss = 0, fPulseInt_quad = 0, fBeta_Cut = 0, fBeta_Full = 0, yx_position_mkj = 0; yx_position_cal = 0; fTiming_Full = 0,fTim1 =0, fTim1_full = 0,fTim2 =0, fTim2_full = 0, fTim3 = 0, fTim3_full = 0, fTim4 = 0, fTim4_full = 0, fFullRead = kFALSE, fFullShow = kFALSE, fTrack = kFALSE, fCut = kFALSE, fPions = kFALSE;}
  virtual ~calibration() { }
