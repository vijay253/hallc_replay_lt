...
void run_cal(Int_t RunNumber = 0, Int_t NumEvents = 0, Int_t coin = 0)
{
  ...
  TChain ch("T");
  if (coin == 1){
    ch.Add("ROOTfiles/shms_coin_replay_production_all_4782_-1.root");
    ch.Add("ROOTfiles/shms_coin_replay_production_all_4783_-1.root"); 
  }
  // There is no need for these to be form statements if you're feeding them a fixed variable
